...
class MomentumIndicators(OHLCV):
    ...
    def cci(self, length: int = 20) -> list:
        ...
        # list comprehension that creates an array of length(close) with each element as 'None'
    ...
    def macd(self, fast_length: int = 12, slow_length: int = 26, signal_length: int = 9) -> list:
        ...
        # list comprehension that creates an array of length(ema26) with each element as 'None'
